...
class MultimodalSentimentModel(nn.Module):
    def __init__(self):
        ...
        self.emotion_classifier = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Dropout(0.2),
            nn.Linear(64, 7) # Sadness, anger, joy, etc.
        )
...
class MultimodalTrainer:
    ...
    def log_metrics(self, losses, metrics=None, phase="train"):
        if phase != "train" and self.current_train_losses is None:
            # Skip logging train losses if not available
            return
        if phase == "train":
        ...
        if metrics:
            ...
            self.writer.add_scalar(
                f'{phase}/emotion_accuracy', metrics['sentiment_accuracy'], self.global_step
            )
    ...
    def train_epoch(self):
        ...
        for batch in self.train_loader:
            ...
            # Zero gradient and set them to zero
    ...
    def evaluate(self, data_loader, phase="val"):
        ...
        #Compute the precision ,accuracy, and weighted F1
